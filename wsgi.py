...
class Midterm(object):
    ...
    def index(self):
        ...
        <a href="drawspur2">2015cda_g3_2015.6.22_Final2_1</a><br />
        <a href="drawspur3">2015cda_g3_2015.6.22_Final2_2</a><br />
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspur2(self, N1=20, N2=10, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspuraction2(self, N1=20, N2=10, N3=30, N4=10, N5=20, N6=30, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
